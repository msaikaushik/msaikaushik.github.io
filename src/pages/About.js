  ...
  return (
    <div className="container mx-auto px-4 pt-12">
        ...
        <div className="md:col-span-1">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <ul className="space-y-2">
              <li>
                <a href="/path/to/your/resume.pdf" className="text-blue-600 hover:underline flex items-center">
                  <FileText size={18} className="mr-2" /> Download Resume
                </a>
              </li>
              <li>
                <a href="mailto:m.saikaushik97@gmail.com" className="text-blue-600 hover:underline flex items-center">
                  <Mail size={18} className="mr-2" /> m.saikaushik97@gmail.com
                </a>
              </li>
              <li>
                <a href="https://linkedin.com/in/msaikaushik" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline flex items-center">
                  <Linkedin size={18} className="mr-2" /> LinkedIn Profile
                </a>
              </li>
              <li>
                <a href="https://github.com/msaikaushik" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline flex items-center">
                </a>
              </li>
            </ul>
          </div>
      ...
      {/* <div className="mt-12 text-center">
        <Link to="/projects" className="bg-blue-600 text-white px-6 py-3 rounded-full inline-flex items-center hover:bg-blue-700 transition-colors">
          View My Projects
        </Link>
      </div> */}
    </div>
